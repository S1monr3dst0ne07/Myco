...
#define fork() -1  // Windows doesn't support fork
#define execlp(file, arg0, ...) -1  // Windows doesn't support execlp
#define _exit(code) exit(code)
// Don't redefine pid_t on Windows - it's already defined
#else
#include <unistd.h>
#include <sys/types.h>
#include <sys/wait.h>
