...
static TokenType keyword_to_token(const char* keyword) {
    if (strcmp(keyword, "let") == 0) return TOKEN_LET;
    if (strcmp(keyword, "func") == 0) return TOKEN_FUNC;
    if (strcmp(keyword, "if") == 0) return TOKEN_IF;
    if (strcmp(keyword, "else") == 0) return TOKEN_ELSE;
    if (strcmp(keyword, "while") == 0) return TOKEN_WHILE;
    if (strcmp(keyword, "for") == 0) return TOKEN_FOR;
    if (strcmp(keyword, "in") == 0) return TOKEN_IN;
    if (strcmp(keyword, "switch") == 0) return TOKEN_SWITCH;
    if (strcmp(keyword, "case") == 0) return TOKEN_CASE;
    if (strcmp(keyword, "try") == 0) return TOKEN_TRY;
    if (strcmp(keyword, "catch") == 0) return TOKEN_CATCH;
    if (strcmp(keyword, "return") == 0) return TOKEN_RETURN;
    if (strcmp(keyword, "end") == 0) return TOKEN_END;
